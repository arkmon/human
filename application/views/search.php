   ...
   <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="http://www.ecwm604.us/w1291692">Human Resources</a>
...
<div id="wrap">
    <div class="container">
	<form action="http://www.ecwm604.us/w1291692/index.php/find/findemp" method="GET">
                <div>
                    <div>First name:         <input type=text name='firstname'> </div>
                    <div>Last name:          <input type=text name='lastname'> </div>
                    <div>Department Name:    <select type="text" name="dept" id="dept">
            <option value="">Select Department</option>
                    ...
                    <div>Current job Title:  <input type=text name='jobtitle'> </div>
